  ...
  return (
    ...
    <>
      ...
      <div className="section section-basic" id="basic-elements" style={{
        opacity: "0.7", backgroundImage: 'linear-gradient(to bottom,rgba(109, 213, 250, 0.675), rgba(41, 128, 185, 0.85), rgba(109, 213, 250, 0.675), rgba(255,255,255,1)),url(https://images.unsplash.com/photo-1579719558505-ad4a5fee0847?ixlib=rb-1.2.1&dpr=1&auto=format&fit=crop&w=1600&h=500&q=60)'
      }}  id='aboutPage'>
        <Container  style={{maxWidth: '80%'}} >
          <Row>
            <Col>
              <Nav className="justify-content-lg-center" role="tablist" tabs style={{
                border: '0',
                borderRadius: '15px',
                ...
                <NavItem>
                  <NavLink
                    ...
                    style={{ fontSize: '20px', marginBottom: '0', fontFamily: 'distant_galaxyregular' }}
                  >
                    {/* <i className="now-ui-icons ui-1_email-85"></i> */}
                    WELCOME TO IJCST 2022
                  </NavLink>
                </NavItem>
              </Nav>
      ...
      <Container id='conferenceDetail' className="section section-basic" style={{ maxWidth: '100%', padding: '10px' }}>
      ...
      <Col className="flex mb-5 " style={{ display: 'flex', flexDirection: 'row', marginTop: '0', maxWidth: '50%', justifyContent: 'center', margin: 'auto' }}>
        <div class="card mb-3">
          <img
            alt="..."
